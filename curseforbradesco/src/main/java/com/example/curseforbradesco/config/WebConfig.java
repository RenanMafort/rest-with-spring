...
import com.example.curseforbradesco.serialization.convert.YamlJackson2HttpMessageConverter;
...
//                .mediaType("xml",MediaType.APPLICATION_XML);
        ...
        configurer.favorParameter(false).ignoreAcceptHeader(false)
                .useRegisteredExtensionsOnly(false)
                .mediaType("xml",MediaType.APPLICATION_XML)
                .mediaType("x-yaml",MEDIA_TYPE_APPLICATION_YML).defaultContentType(MediaType.APPLICATION_JSON);
