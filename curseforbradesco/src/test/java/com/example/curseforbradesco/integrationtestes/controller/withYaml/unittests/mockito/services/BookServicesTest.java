package com.example.curseforbradesco.integrationtestes.controller.withYaml.unittests.mockito.services;
...
import com.example.curseforbradesco.integrationtestes.controller.withYaml.unittests.mapper.mocks.MockBook;
...
public class BookServicesTest {
    ...
    void testFindAll() {
        ...
        assertTrue(bookOne.toString().contains("links: [</api/person/v1/1>;rel=\"self\"]"));
        ...
        assertTrue(bookFour.toString().contains("links: [</api/person/v1/1>;rel=\"self\"]"));
        ...
        assertTrue(bookSeven.toString().contains("links: [</api/person/v1/1>;rel=\"self\"]"));
